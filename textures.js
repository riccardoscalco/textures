...
(function() {
  ...
  umd(function() {
    return {
      circles: function() {
        var background, backgroundOpacity, circles, complement, fill, fillOpacity, id, radius, size, stroke, strokeOpacity, strokeWidth;
        size = 20;
        background = "";
        backgroundOpacity = 1;
        radius = 2;
        ...
        circles.backgroundOpacity = function(_) {
          backgroundOpacity = _;
          return circles;
        };
        ...
        circles.fillOpacity = function(_) {
          fillOpacity = _;
          return circles;
        };
      ...
      lines: function() {
        var background, backgroundOpacity, id, lines, orientation, path, shapeRendering, size, stroke, strokeOpacity, strokeWidth;
        size = 20;
        strokeWidth = 2;
        stroke = "#343434";
        strokeOpacity = 1;
        ...
        lines.backgroundOpacity = function(_) {
          backgroundOpacity = _;
          return lines;
        };
      ...
      paths: function() {
        var background, backgroundOpacity, d, fill, height, id, paths, shapeRendering, size, stroke, strokeOpacity, strokeWidth, svgPath, width;
        size = 20;
        height = 1;
        width = 1;
        strokeWidth = 2;
        ...
        paths.backgroundOpacity = function(_) {
          backgroundOpacity = _;
          return paths;
        };
